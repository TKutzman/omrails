...
class ExperiencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create experience" do
    assert_difference('Experience.count') do
      post experiences_url, params: { experience: { content: @experience.content, topic: @experience.topic, user_id: @experience.user_id } }
    end
  ...
  test "should update experience" do
    patch experience_url(@experience), params: { experience: { content: @experience.content, topic: @experience.topic, user_id: @experience.user_id } }
